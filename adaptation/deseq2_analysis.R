...
comp_samples = c('M9LQ','M9SF') # first is control, second is treatment
# for this dataset, want to keep  all conditions
# for NAND, need to rethink this since there are so many conditions
NAME = 'condition_M9SF_vs_M9LQ' # 'condition_M9LQ_vs_LB0', 'condition_M9SF_vs_LB0'
...
# write.csv(as.data.frame(res), file="M9SF_vs_M9LQ_res.csv")
